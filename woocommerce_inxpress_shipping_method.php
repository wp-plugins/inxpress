		...
		if ( ! class_exists( 'WC_inxpress_shipping_method' ) ) {
			...
			class WC_inxpress_shipping_method extends WC_Shipping_Method {
				...
				function init_form_fields() {
					echo '<img src="' . plugins_url( 'assets/inxpress.png', __FILE__ ) . '" />';									
...
function custom_plugin_card_icons( $plugin_icon, $plugin = null, $plugin_url = '' ) {
	...
	if ( 'equal-height-columns' === $plugin->slug ) {
		$plugin_icon = '<a href="' . esc_url( $plugin_url ) . '" class="plugin-icon"><img src="' . plugins_url( 'assets/inxpress.png', __FILE__ ) . '" /></a>';
	}
