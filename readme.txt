...
Donate link: 
Tags: woocommerce
Requires at least: wordpress 3.8 or higher and woocommerce 2.1.0 or higher
Tested up to: woocommerce 2.1.0 or higher
Stable tag: 1.0.0
...
Step 2 – Go to Plugins --> Add New --> Upload --> Browse (Select InXpress_Shipping.zip from the Inxpress WooCommerce package on your computer)
Step 3 - Then Click on “Install” button to start the installation. When installation is complete you will get a message for activating the plugin.
Step 4 - Here you can see 2 links one for "Activate Plugin" and one for "Return Plugin Page". Now please click "Activate Plugin" link to activate this extension.
...
1.0.0 New version for this shipping extension
